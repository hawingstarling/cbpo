...
class Command(BaseCommand):
    help = "Migrate grant access permission mat_am_view, mat_am_edit of MT to user client role owner, admin."
    ...
    def handle(self, *args, **options):
        ...
        2. Grant permission MT to user client has role ["OWNER", "ADMIN"]
        :param args:
        :param options:
        :return:
        """
        print("Begin update permission of MT module")
        permisisons = ['mat_am_view', 'mat_am_edit']
        print('List permission update : {}'.format(','.join(permisisons)))
        try:
            # 1
        ...
        print("End update permission of MT module")
