...
class Command(BaseCommand):
    help = "Migrate grant access permission dc_tool_index_man of DC to user client role owner, admin."
    ...
    def handle(self, *args, **options):
        ...
        :return:
        """
        print("Begin update permission of DC module")
        try:
            # 1
        ...
        print("End update permission of DC module")
