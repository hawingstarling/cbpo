...
def get_query_set_filter_top_asins(client_id: str, ids: list = [], sort_field: str = None, channel: str = None,
                                   sort_direction: str = None, keyword: str = None, **kwargs):
    sort_config = []
    if sort_field:
        sort_config = [ISortConfigPostgresFulltextSearch(
            field_name=sort_field, direction=sort_direction)]
    #
    queryset = TopClientASINs.objects.tenant_db_for(
