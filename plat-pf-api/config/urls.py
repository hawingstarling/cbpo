...
schema_view = get_schema_view(
    openapi.Info(
        title="PRECISE FINANCIAL API",
        default_version='v1',
        description="Precise Financial API",
        contact=openapi.Contact(email="no-reply@hdwebsoft.com"),
        license=openapi.License(name="Precise Financial License"),
    ),
    public=True,
...
urlpatterns = [
    ...
    path('ds-proxy/', include('app.core.sub_urls.ds_proxy')),
    path('ps-proxy/', include('app.core.sub_urls.ps_proxy')),
]
