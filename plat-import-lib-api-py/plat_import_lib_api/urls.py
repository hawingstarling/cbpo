...
from .sub_views.module import ImportModuleListView, ListModuleKeysView
from .sub_views.export import ExportSerializer, ExportSampleView, ExportInvalidView, ExportErrorView
from .sub_views.columns import ModuleColumnsView

urlpatterns = [
    path(r'history', ListImportHistoryView.as_view(), name='import-history'),
    path(r'modules-keys', ListModuleKeysView.as_view(), name='modules-keys'),
    ...
    path(r'<slug:module>/columns', ModuleColumnsView.as_view(), name='columns-of-module'),
