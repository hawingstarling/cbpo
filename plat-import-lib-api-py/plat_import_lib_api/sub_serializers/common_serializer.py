...
class TargetColumnDefaultField(serializers.Field):
    def to_internal_value(self, data):
        if isinstance(data, fields.empty):
            return None
        return str(data)
...
class TargetColumnsSerializer(ColumnsSerializer):
    ...
    default = TargetColumnDefaultField(required=False, allow_null=True, default=None)
